#define MyAppName "Gchange"
#define MyAppPublisher "Gchange Team"
#define MyAppURL "http://gchange.fr"
...
[Icons]
Name: "{group}\{#MyAppName}"; IconFilename: "{app}\gchange\img\favicon.ico"; Filename: "{app}\{#MyAppExeName}"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\{#MyAppName}"; IconFilename: "{app}\gchange\img\favicon.ico"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon
...
AppId={{DA3E955D-F840-8274-DED2-D3C79C306D2}
